...
#Function handles kohonen training 
...
#Read and process data
    max_iterations, data_file, resutls_file, centers_file, weights_file = io.read_rbf_params('parameters.txt') 
    print(data_file)
    ...
    #Reduce learning rate algorithm:
        ...
        #        slrate = slrate*0.5
            #Check if overfitting condition
                ...
                #break
    io.overwrite_file(weights_file) 
    io.write_string(weights_file,"RBF Centers:\n")
    io.write_array_data(weights_file, centers) 
    io.write_string(weights_file,"\nRBF Coefficients:\n")
    io.write_vector_data(weights_file,coeffs)
    io.write_string(weights_file,"\nRBF Radii(Sigma):\n")
    io.write_vector_data(weights_file,sigmas)
